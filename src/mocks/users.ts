...
export const mockUsers: User[] = [
    ...
    {
        id: '2', name: 'Maria Silva', email: 'maria@nexus.com', status: 'PENDING',
    ...
    {
        id: '3', name: 'Carlos Weber', email: 'carlos@web.com', status: 'BLOCKED',
    ...
    {
        id: '5', name: 'Lucas Pires', email: 'lucas@nexus.com', status: 'ACTIVE',
    ...
    {
        id: '6', name: 'Beatriz Lima', email: 'bia@email.com', status: 'PENDING',
    ...
    {
        id: '7', name: 'Ricardo Ohara', email: 'ricardo@tech.com', status: 'ACTIVE',
    ...
    {
        id: '8', name: 'Fernanda Montenegro', email: 'fer@atuacao.com', status: 'ACTIVE',
    ...
    {
        id: '9', name: 'Roberto Carlos', email: 'rei@musica.com', status: 'BLOCKED',
    ...
    {
        id: '10', name: 'Julia Roberts', email: 'julia@cinema.com', status: 'ACTIVE',
